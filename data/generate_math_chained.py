...
def gen_derivative_verify(rng: random.Random, inject_error: bool):
...
def gen_factor_verify(rng: random.Random, inject_error: bool):
...
def gen_solve_verify(rng: random.Random, inject_error: bool):
...
def gen_tangent_verify(rng: random.Random, inject_error: bool):
...
def gen_quadratic_solve_verify(rng: random.Random, inject_error: bool):
...
def gen_arithmetic_inverse_verify(rng: random.Random, inject_error: bool):
...
def paired_derivative_verify(rng: random.Random):
...
def paired_factor_verify(rng: random.Random):
...
def paired_solve_verify(rng: random.Random):
...
def paired_tangent_verify(rng: random.Random):
...
def paired_quadratic_verify(rng: random.Random):
...
def paired_arithmetic_verify(rng: random.Random):
...
if __name__ == "__main__":
    ...
    if args.mode == "corpus":
        ...
        generate_paired_test(args.n, args.seed, args.output)
